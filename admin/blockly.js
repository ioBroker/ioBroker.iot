...
// --- ifttt --------------------------------------------------
Blockly.Words['ifttt_iot']           = {"en": "Send text to IFTTT via iot",                      "de": "Sende Text zu IFTTT über iot",                    "ru": "Послать текст в IFTTT через iot",                 "pt": "Enviar texto para o IFTTT via iot",               "nl": "Verstuur tekst via iot naar IFTTT",               "fr": "Envoyer du texte à IFTTT via iot",                "it": "Invia il testo a IFTTT tramite iot",              "es": "Enviar texto a IFTTT a través de iot",            "pl": "Wyślij tekst do IFTTT przez iot",                 "zh-cn": "通过iot发送文本到IFTTT"};
