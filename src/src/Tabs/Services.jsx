    ...
    reissueUrlKey() {
        ...
        return this.props.socket
            ...
            .then(() =>
                this.setState({
                    running: false,
                    toast: I18n.t('Certificates will be updated after initiated restart'),
                }),
            )
            .catch(err => {
        ...
        return (
            <form style={styles.tab}>
                ...
                <Fab
                    ...
                    onClick={() =>
                        Utils.copyToClipboard(
                            `https://service.iobroker.in/v1/iotService?service=ifttt&key=${this.state.key}&user=${encodeURIComponent(this.props.native.login)}`,
                        )
                    }
                >
                    <IconCopy />
                ...
                <Fab
                    ...
                    onClick={() =>
                        Utils.copyToClipboard(
                            `https://service.iobroker.in/v1/iotService?service=custom_<SERVICE_NAME>&key=${this.state.key}&user=${encodeURIComponent(this.props.native.login)}&data=<SOME_TEXT>`,
                        )
                    }
                >
                    <IconCopy />
                ...
                <FormControl
                    style={{ ...styles.input, ...styles.controlElement, paddingTop: 20 }}
                    variant="standard"
                >
                    <Select
                        variant="standard"
                    ...
                    >
                        ...
                        {this.state.text2commandList.map(item => (
                            <MenuItem
                                key={`key-${item}`}
                                value={item}
                            >
                ...
                >
                    ...
                    >
                        ...
                        {this.state.nightscoutList.map(item => (
                            <MenuItem
                                key={`key-${item}`}
                                value={item}
                            >
