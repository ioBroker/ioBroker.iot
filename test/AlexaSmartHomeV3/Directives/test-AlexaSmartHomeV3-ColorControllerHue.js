...
describe('AlexaSmartHomeV3 - ColorControllerSingleRgb', function () {
    beforeEach(function () {
    ...
    describe('Handling', async function () {
        ...
        it('ColorController TurnOff', async function () {
            ...
            let storedValue = await AdapterProvider.get().getForeignStateAsync(id);
            assert.equal(storedValue.val, 0, 'ioBroker.Value!');
        ...
        it('ColorController TurnOn', async function () {
            ...
            let id = helpers.getConfigForName('BRIGHTNESS', helpers.hueConfig());
            let storedValue = await AdapterProvider.get().getForeignStateAsync(id);
            assert.equal(storedValue.val, 100, 'ioBroker.Value!');
