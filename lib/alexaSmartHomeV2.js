...
function AlexaSH2(adapter) {
    ...
    function controlTemperature(id, value, writeStates, callback) {
        ...
        adapter.getForeignObject(id, function (err, obj) {
            ...
            if (!obj.common.role || obj.common.role.indexOf('value.temperature') === -1) {
                adapter.log.debug('[ALEXA] Cannot control ' + id + '. Role is not value.temperature.');
                if (callback) callback();
                return;
            }
    ...
    function getTemperature(id, writeStates, callback) {
        adapter.getForeignObject(id, function (err, obj) {
            ...
            if (!obj.common.role || obj.common.role.indexOf('level.temperature') === -1) {
    ...
    function getTargetTemperature(id, writeStates, callback) {
        adapter.getForeignObject(id, function (err, obj) {
            ...
            if (!obj.common.role || obj.common.role.indexOf('value.temperature') === -1) {
                adapter.log.debug('[ALEXA] Cannot read device ' + id + '. Role is not value.temperature.');
                if (callback) callback();
                return;
            }
