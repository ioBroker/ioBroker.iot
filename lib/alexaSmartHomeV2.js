...
function AlexaSH2(adapter) {
    ...
    function processState(states, id, room, func, alexaIds, groups, names, result) {
        ...
        try {
            ...
            if (friendlyName === 'ignore' || friendlyName === false) {
                return `"${id}" must be ignored, becasue of the settings`;
            }
    ...
    this.getDevices = function (callback) {
        ...
        adapter.objects.getObjectView('system', 'state', {}, (err, _states) => {
            let states   = {};
            let ids      = [];
            let alexaIds = [];
            let groups   = {};
            ...
            ids.sort();
            adapter.objects.getObjectView('system', 'enum', {}, (err, doc) => {
