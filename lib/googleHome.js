        ...
        if (!this.keyPromise || now - this.keyPromiseTime > 900000) {
            ...
            this.keyPromise = axios.get(url, {validateStatus: status => status === 200})
                ...
                .catch(error => {
                    ...
                    this.adapter.config.googleHome && this.adapter.log.error('[GHOME] Url Key error. Google Request and Response are working. But device states are not reported automatically. If you have pro license please try to delete iot.0.certs: ' + errorMessage);
                });
        }
