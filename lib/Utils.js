...
class Utils {
    ...
    static getHostname(instanceObj, objects, hosts, currentHostname, adminInstance) {
        ...
        const adminHost = objects['system.adapter.' + adminInstance] && objects['system.adapter.' + adminInstance].common && objects['system.adapter.' + adminInstance].common.host;
                    ...
                    if (placeholder === '%ip%') {
                        ...
                        if (!placeholder.includes('_')) {
                            ...
                            if (_urls.length) {
                                ...
                                port = context.objects['system.adapter.' + adapterInstance] &&
                                ...
                                ids.forEach(id => {
                                    if (_urls.length) {
                                        ...
                                        if (item) {
                                            ...
                                            const _port = context.objects['system.adapter.' + id] &&
