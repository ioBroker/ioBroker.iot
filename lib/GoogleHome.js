                            ...
                            rooms.forEach(roomId => {
                                ...
                                if (pos !== -1) {
                                    ...
                                    if(objects[id] && objects[id].type === "state") {
                                        this.adapter.log.warn(id + " is a state. It's recommended to add rooms and functionality to channels or devices and not to a state to get autodetected for Google Home")
                                    }
