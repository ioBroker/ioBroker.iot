...
const traitEnum = {
    ...
    "action.devices.traits.ColorSetting_temperature": 'color_temperature',
    "action.devices.traits.ColorSetting_spectrumRGB": 'color_spectrumRGB',
...
class GoogleHome {
    ...
    processState(ids, objects, id, roomName, funcName, result) {
        ...
        if (smartName.ghTraits && smartName.ghTraits.length > 0 && smartName.ghTraits[0]) {
            ...
            const setKey = "set_" + command;
            const getKey = "get_" + command;
