        ...
        return new Promise((resolve, reject) => {
            ...
            request.get({
                ...
                if (!error && response.statusCode === 200) {
                    ...
                    this.adapter.log.error('[GHOME] Cannot report device state: ' + error);
                    reject(error || body);
                }
            });
        });
            ...
            this._updateDevices()
                .then(smartDevices => {
                    ...
                    this.checkUrlKey()
                        ...
                        .catch(err => this.adapter.log.warn('[GHOME] Invalid URL key. Status update is disabled: ' + err));
                });
        });
    }
        ...
        request.post({
            ...
            if (!error && response.statusCode === 200) {
                ...
                if (response.statusCode === 404) {
                    ...
                    this.adapter.log.error('[GHOME] Cannot report devices state: ' + error);
                }
            }
        });
    }
