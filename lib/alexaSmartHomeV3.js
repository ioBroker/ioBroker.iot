        ...
        try {
            ...
            for (let i = friendlyNames.length - 1; i >= 0; i--) {
                ...
                if (!friendlyNames[i]) {
                    ...
                    friendlyNames[i] = friendlyNames[i].substring(0, 128).replace(/[^.a-zA-Z0-9äÄüÜöÖßÉéÈèÀàÂâÊêÙùÛûÇçÎîËëÏïŸÿÔô]+/g, ' ');
                }
            }
            ...
            */
            ...
            friendlyDescription = friendlyDescription.substring(0, 128).replace(/[^.a-zA-Z0-9äÄüÜöÖßÉéÈèÀàÂâÊêÙùÛûÇçÎîËëÏïŸÿÔô]+/g, ' ');
