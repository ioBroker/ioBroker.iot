...
let newInstanceIfDoesntExist = function (capabilityName, capabilities) {
    let capability = capabilities.find(c => c.namespace === capabilityName)
    if (!capability) {
...
class CapabilityFactory {
    /**
     * Tries to map the given device with detected controls to a set of Alexa capabilities
     * @param device Contains the detected device.
            ...
            switch (ctrl.type) {
                ...
                case 'light':
                    ...
                    */
                    ...
                    // PowerController
                    capability = newInstanceIfDoesntExist('PowerController', capabilities);
                ...
                case 'dimmer':
                    ...
                    */
                    ...
                    capability = newInstanceIfDoesntExist('BrightnessController', capabilities);
                    capability.addStateContainer(new StateContainer({
                        setStateId: setState.id,
                        getStateId: getState?.id || setState.id,
                    }))
