...
class Control {
    ...
    // TODO: how to deal with it on per property basis?
    get valuesRangeMin() {
    ...
    async handle(event) {
        ...
        if (eventHandler) {
            ...
            const response = AlexaResponse.handled(event, eventHandler.property.propertyName, alexaValue);
    ...
    async reportState() {
        ...
        this.log.silly(`${JSON.stringify(propertiesToReport)}`);
