...
class Control {
    ...
    async adjustValue(event, eventHandler) {
        // extract Alexa adjustment from event
        const adustBy = eventHandler.capability.alexaValue(event);
        // get current value
        ...
        // adjust Alexa value
        const adjustedValue = Utils.ensureValueInRange_0_100(valueToAdjust + adustBy);
