...
class AirCondition extends AdjustableControl {
    ...
    initCapabilities() {
        ...
        this._thermostatMode = this._thermostatController.properties[0];
        this._powerController = new Capabilities.PowerController();
        this._powerState = this._powerController.properties[0];
    ...
    async setState(property, value) {
        ...
        if (property.propertyName === Properties.PowerState.propertyName && !this.dedicatedOnOff) {
            ...
            if (value) {
                this._lastKnownMode = this._lastKnownMode || this._supportedModesAsEnum[Properties.Thermostat.AUTO];
                ...
                const modeOffValue = this._supportedModesAsEnum[Properties.Thermostat.OFF];
            ...
            if (property.name === Properties.ThermostatMode.propertyName) {
    ...
    async getOrRetrieveCurrentValue(property) {
        if (property.currentValue === undefined) {
            ...
            if (property.propertyName === this._powerState.propertyName && !this.dedicatedOnOff) {
                property.currentValue = property.currentValue !== this._supportedModesAsEnum[Properties.Thermostat.OFF];
            }
        }
    ...
    composeInitObject(property) {
        ...
        if (property.propertyName === Properties.ThermostatMode.propertyName) {
            const initObject = {
                ...
                alexaSetter: function (alexaValue) {
                    return this._supportedModesAsEnum[alexaValue];
                },
                alexaGetter: function (value) {
                    return this._supportedModesAsEnum[value];
                },
