...
module.exports = {
    ...
    parseISOString(dateTimeAsISOString) {
        var b = dateTimeAsISOString.split(/\D+/);
    ...
    configuredRangeOrDefault(state) {
        ...
        const min = configuredMin === undefined || isNaN(configuredMin) ? 0 : configuredMin;
        const max = configuredMax === undefined || isNaN(configuredMax) ? 100 : configuredMax;
