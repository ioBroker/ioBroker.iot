...
module.exports = {
    ...
    */
    endpointName: function (controls, lang, funcNameFirst, concatination) {
        ...
        let roomName = controls.room?.common?.name;
        if (roomName) {
            ...
            let funcName = controls.functionality?.common?.name;
            if (funcName && typeof funcName === 'object') {
                funcName = funcName.en;
            }
            ...
            name = `${funcNameFirst ? funcName : roomName}${concatination ? (' ' + concatination + ' ') : ''}${funcNameFirst ? roomName : funcName}`;
