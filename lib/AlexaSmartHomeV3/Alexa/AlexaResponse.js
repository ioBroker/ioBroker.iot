...
class AlexaResponse {
    ...
    asEndpointCapability(opts) {
        ...
        let response = {
            ...
            instance: Utils.defaultIfNullOrEmpty(opts.instance, 'ioBroker.Mode.Controller.Instance'),
            configuration: Utils.defaultIfNullOrEmpty(opts.configuration, {}),
            capabilityResources: Utils.defaultIfNullOrEmpty(opts.capabilityResources, {}),            
        };

        for (const prop in ['instance', 'configuration', 'capabilityResources']) {
