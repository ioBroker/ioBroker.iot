...
class AlexaResponse {
    ...
    addPayloadProperty(opts) {
        ...
        if (this.event.payload.change === undefined) {
            this.event.payload.change = {
                cause: {
                    type: Utils.defaultIfNullOrEmpty(opts.changeCauseType, "PHYSICAL_INTERACTION")
                },
                properties: []
            }
        }
    ...
    addPayloadEndpoint(opts) {
        ...
        let endpoint = {
            ...
            description: Utils.defaultIfNullOrEmpty(opts.description, "Dummy Endpoint Description"),
